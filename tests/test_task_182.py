...
class TestTask182(TestCase):
    ...
    def test_assert_equal(self):
        ...
        self.assertEqual(task_182(*test_list), (1, 40))

    def test_assert_raises(self):
        """ Test with string in sequence """
        self.assertRaises(AssertionError, task_182, "[2, 3, 4]")

    def test_with_negative_arr(self):
        """ Test with negative numbers in sequence """
        test_list = [-6]
        self.assertEqual(task_182(*test_list), (0, 0))

    def test_with_zero(self):
        """ Test with zero """
        test_list = []
        self.assertRaises(AssertionError, task_182, test_list)

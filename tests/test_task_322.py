...
from tasks.task_322 import (get_divisors_list, task_322)
...
class TestGetNumberWithLargestSumOfDivisors(TestCase):
    ...
    def test_without_arguments(self):
        ...
        self.assertRaises(TypeError, task_322)
        self.assertRaises(TypeError, task_322, 1)
    ...
    def test_negative_result(self):
        """Test with negative result expectation."""
        self.assertNotEqual(task_322(1, 10), 5)
        self.assertNotEqual(task_322(111, 222), 100)

    def test_positive_result(self):
        """Test with positive result expectation."""
        self.assertEqual(task_322(1, 10), 8)
        self.assertEqual(task_322(111, 222), 106)
